...
public class Insert{
    ...
    */
    public static void insertWarehouseItem(String warehouse_area, String warehouse_row, String row_area, String shelf, int bin, String manufacturer, int productCodeOne, String product, int productCodeTwo, String sku, String barcodeIMG) {// String picture
        try (Connection con = connection()) {
            try{
                String sql = "INSERT INTO warehouse (warehouse_uid, warehouse_area, warehouse_row, row_area, shelf, bin, manufacturer, product_code_one, product, product_code_two, sku, barcode_img) VALUES(uuid_generate_v4(), ?,?,?,?,?,?,?,?,?,?,?)";
