package com.devserendipity.warehousemanagementsystem.files;

import com.devserendipity.warehousemanagementsystem.Connection.Connect;
...
public final class Insert {
    ...
    public static void insertWarehouseItem(String warehouse_area, String warehouse_row, String row_area, String shelf,
            int bin, String manufacturer, int productCodeOne, String product, int productCodeTwo, String sku,
            String barcodeIMG) {
        // String picture
